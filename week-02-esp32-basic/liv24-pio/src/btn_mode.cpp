...
//
//   DEV ─(hold 3 s from mode != USER)─▶ back to USER
//
...
static void button_task(void *arg)
{
    ...
    while (1) {
        ...
        // ── While held: check progressive thresholds ─────────────────────────
            ...
            if (!dev_fired && held_ms >= HOLD_MS_DEV) {
                dev_fired = true;
